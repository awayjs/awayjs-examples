...
module examples
{
    export class AircraftDemo
    {
        ...
        //{ sea
        private _seaGeom			: away.prefabs.PrimitivePlanePrefab;
        ...
        //{ skybox
        private _waterMethod        : away.materials.NormalSimpleWaterMethod
        ...
        private initSea():void
        {
			...
			this._seaMesh = <away.entities.Mesh> this._seaGeom.getNewObject();
